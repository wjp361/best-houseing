package com.house.besthouseing.common.redis.service;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.house.besthouseing.common.redis.dao.RedisDataSource;
import com.house.besthouseing.common.util.CommonUtil;
...
public class RedisClientTemplate {
	...
	/**
	 * 方法说明:	设置缓存
	 * 创建时间:	2017年8月23日 下午3:49:03
	 * 创建人:	zhanlan
	 * 修改记录:	修改人	修改记录	2017年8月23日 下午3:49:03
	 */
	public String setObject(String key, Object value , int cacheSeconds) {
		...
		try {
			...
			result = shardedJedis.set(bytesKey, bytes);
			if (cacheSeconds != 0) {
				shardedJedis.expire(key, cacheSeconds);
			}
		} catch (Exception e) {
	...
	public static byte[] getBytesKey(Object object){
		if(object instanceof String){
			byte[] bytes = StringUtils.getBytes((String)object);
    		return bytes;
    	}else{
    		return CommonUtil.serialize(object);
    	}
	}
	/**
	 * Object转换byte[]类型
	...
	public Object toObject(byte[] bytes){
		return CommonUtil.deserialize(bytes);
	}
	/**
	 * 设置单个值
	 * @param key
