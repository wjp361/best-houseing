...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	/**
	 * 
	 * 方法说明:	获取当前时间距离一天结束的剩余秒数
	 * 创建时间:	2019年2月14日 下午2:57:09
	 * 创建人:		xiaomeng
	 * 修改记录:	修改人	修改记录	2019年2月14日 下午2:57:09
	 * @return
	 
	 */
	public static Integer getRemainSecondsOneDay() {
		LocalDateTime midnight = LocalDateTime.ofInstant(new Date().toInstant(), ZoneId.systemDefault()).plusDays(1)
